...
exports.BallotDTO = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.createdAt !== undefined) {
            timestamp_1.Timestamp.encode(message.createdAt, writer.uint32(42).fork()).ldelim();
        }
        if (message.updatedAt !== undefined) {
            timestamp_1.Timestamp.encode(message.updatedAt, writer.uint32(50).fork()).ldelim();
        }
...
exports.PollDTO = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.createdAt !== undefined) {
            timestamp_1.Timestamp.encode(message.createdAt, writer.uint32(34).fork()).ldelim();
        }
        if (message.closesAt !== undefined) {
            timestamp_1.Timestamp.encode(message.closesAt, writer.uint32(42).fork()).ldelim();
        }
        if (message.topic !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.closesAt = timestamp_1.Timestamp.decode(reader, reader.uint32());
                    break;
                case 6:
                    message.topic = reader.string();
                    break;
    ...
    fromPartial(object) {
        ...
        message.closesAt =
            object.closesAt !== undefined && object.closesAt !== null
                ? timestamp_1.Timestamp.fromPartial(object.closesAt)
                : undefined;
        message.topic = object.topic ?? "";
        message.options = Object.entries(object.options ?? {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
